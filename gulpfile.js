...
function scripts() {
	return src([
		'node_modules/jquery/dist/jquery.min.js', 'app/libs/slick.min.js','app/libs/jquery.magnific-popup.min.js','app/libs/jquery.validate.min.js',// npm vendor example (npm i --save-dev jquery)
